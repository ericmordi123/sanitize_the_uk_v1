"""
Django settings for sanitize_the_uk_v1 project.
...
SECRET_KEY = 'n%1)*+qrtn(pondj^-ox7l)dw##7v1y=fxodbjgl+(y6r$_tya'
...
ROOT_URLCONF = 'sanitize_the_uk_v1.urls'
...
WSGI_APPLICATION = 'sanitize_the_uk_v1.wsgi.application'
